...
protocol SegmentChildProtocol: UIView {
    var isSelected: Bool { get set }
    var isDisabled: Bool { get }
}

extension SegmentChildProtocol {
    var isDisabled: Bool {
        return false
    }
}

final class CustomSegmentView<V, D>: UIView, UpdateDisplayProtocol, Weakifiable where V: SegmentChildProtocol, D: Equatable {
    ...
    init(edges: UIEdgeInsets,
         ...
         scrollView: UIScrollView? = nil, customize: @escaping SegmentCustomize) {
        self.edges = edges
